...
class news_spider():
    ...
    def parser(self, url):
        ...
        if response.status_code == 200:
            ...
            print(self.time_now(),u"request error, please check")
    ...
    def get_article_url(self, name):
        ...
        if name == 'huxiu':
            ...
            print(self.time_now(), u"enter error，please check")
            ...
            if name == 'huxiu':
                ...
                for url in article_url:
                    ...
                    try:
                        ...
                        print(self.time_now(), "Appear error url=", url, e)
                        flag = 1
                    if flag == None:
                        print(self.time_now(), "huxiu success {}".format(news['link']))
                ...
                for url in article_url:
                    ...
                    try:
                        ...
                        flag = 1
                    if flag == None:
                        print(self.time_now(), "leiphone success {}".format(news['link']))
                        # self.save_info(name, news)
                        self.post_data(news)
                ...
                for url in article_url:
                    ...
                    if flag == None:
                        print(self.time_now(), "tmtpost success {}".format(news['link']))
                        # self.save_info(name, news)
                        self.post_data(news)

            else:
                print(self.time_now(), u"Appear error，please check")
        else:
            print(self.time_now(), u"no new url need spider")

    # 用来控制各方法
    def run(self):
        print(self.time_now(), u"Program runing please waiting")
        name_list = ['tmtpost', 'leiphone', 'huxiu']
        # 计数器，记录查询次数
        counter = 0
        while(True):
            counter += 1
            print(self.time_now(), "{}th queries are in progress".format(counter))
            ...
            if time.localtime()[3] > 21:
                # 推迟11个小时
                print(self.time_now(), u"Program delay 11 h")
                time.sleep(25200)
                # 清除存储的文章的url地址,
                self.article_url = []
            else:
                # 推迟两个小时
                print(self.time_now(), u"Program delay 2 h")
                time.sleep(7200)
