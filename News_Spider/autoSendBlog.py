...
class autoSendBlog(object):
    ...
    def getAccessToken(self):
        ...
        app_secret = '626390fdc176e5b8f5e51'
    ...
    def SendBlog(self, news):
        ...
        access_token = '2.001dgV6GMxOjrCaa657e'
        ...
        title_len = len(news['title']) + len(news['url'])
        print('title_len=', title_len, news['title'])
        point = 140 - len(news['url'])
        if title_len > 140:
            content = news['title'][0:point:1] + news['url']
        else:
            content = news['title'] + news['url']
